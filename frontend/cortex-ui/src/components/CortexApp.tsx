...
import type { CortexModuleUi } from "../lib/moduleUi";
import type { CortexBranding } from "../lib/branding";
...
export interface CortexAppProps {
   ...
   * omitted, `CortexApp` creates a sensible default (retry once, no refetch on window focus).
   */
  queryClient?: QueryClient;
}

/**
 * Batteries-included Cortex frontend: wires a React Query provider and a router around the
 ...
 */
export function CortexApp({ moduleUi, branding, queryClient }: CortexAppProps) {
