...
/// <summary>
/// The Nutrition vertical (NutriForge) — the platform's second domain module, proving Plenipo supports
...
public sealed class NutritionModule : IModule
{
    ...
    public ModuleManifest Manifest { get; } = new()
    {
        ...
        Icon = "salad",
        AgentInstructions =
            "You are Plenipo's nutrition assistant. Use search_foods to find catalog items and estimate_meal to " +
