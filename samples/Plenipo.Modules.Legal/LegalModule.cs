...
public sealed class LegalModule : IModule
{
    ...
    public ModuleManifest Manifest { get; } = new()
    {
        ...
        Icon = "scale",
        AgentInstructions =
            "You are Plenipo's legal assistant, organized around MATTERS (engagement workspaces). " +
    ...
    public void RegisterServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<Plenipo.Application.Jobs.IJobHandler, BulkReviewJobHandler>();
        ...
        services.AddScoped<Plenipo.Application.Rag.IRagCollectionGate, MatterRagGate>();
        ...
        services.AddScoped<Plenipo.Application.Connectors.IConnectorSyncHandler, MatterSyncHandler>();
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet("/matters", async (
                LegalDbContext db, Plenipo.Core.Identity.ICurrentUser current, CancellationToken cancellationToken) =>
            {
        ...
        group.MapGet("/matters/{matterId:guid}/detail", async (
                Guid matterId, LegalDbContext db, Plenipo.Core.Identity.ICurrentUser current,
