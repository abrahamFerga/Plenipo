...
namespace Plenipo.Modules.Legal.Tests;
...
public sealed class LegalCatalogTests
{
    ...
    // is covered end-to-end in Plenipo.Sample.Host.IntegrationTests.LegalLibraryTests.
    ...
    public void Manifest_DeclaresClauseAndMatterToolsWithApprovalGatedWrites()
    {
        ...
        Assert.Equal(
            ["search_clauses", "draft_clause", "create_matter", "list_matters", "attach_document_to_matter", "list_matter_documents", "get_playbook", "save_clause", "remove_clause", "add_playbook_rule", "remove_playbook_rule", "start_bulk_review", "index_matter_documents", "add_deadline", "list_deadlines", "complete_deadline", "add_party", "list_parties", "check_conflicts", "log_time", "list_time", "add_task", "list_tasks", "complete_task", "get_matter_overview", "export_prebill", "close_matter", "reopen_matter", "draft_status_update", "restrict_matter_access", "open_matter_access", "connect_matter_folder", "sync_matter_folder"],
