...
/// manifest-first plugin the host registers once (<c>AddPlenipoConnector&lt;T&gt;()</c>) and a tenant
...
public sealed record ConnectorManifest
{
    ...
    public IReadOnlyList<Plenipo.Modules.Sdk.ToolDescriptor> Tools { get; init; } = [];
