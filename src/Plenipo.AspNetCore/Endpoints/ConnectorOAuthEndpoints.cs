...
{
    private const string StatePurpose = "Plenipo.Connectors.OAuthState";
    ...
    public static void MapConnectorOAuthEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/{connectorId}/oauth/callback", async (
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                return Results.Text($"Connected. You can close this window and return to Plenipo — the '{connectorId}' connector is now linked to your account.");
            })
