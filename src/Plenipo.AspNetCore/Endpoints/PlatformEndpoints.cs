...
public static class PlatformEndpoints
{
    public static void MapPlatformEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/modules", async (
            ...
            Plenipo.Infrastructure.Persistence.PlatformDbContext db, ISkillCatalog skills, CancellationToken ct) =>
        {
        ...
        // (Branding:ProductName). This is what lets ONE prebuilt @plenipo/ui bundle serve every
    ...
    private static ModuleDto ToDto(
        ModuleManifest manifest, ICurrentUser user, IEnumerable<Plenipo.Core.Platform.AgentProfile> tenantProfiles,
