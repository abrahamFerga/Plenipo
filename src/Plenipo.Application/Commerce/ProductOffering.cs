...
/// (<see cref="ProductOfferingRegistration.AddPlenipoProduct"/>), the same way it installs its
...
public static class ProductOfferingRegistration
{
    ...
    public static IServiceCollection AddPlenipoProduct(this IServiceCollection services, ProductOffering offering)
    {
    ...
    public static IServiceCollection AddPlenipoTenantProvisionedHook<THook>(this IServiceCollection services)
