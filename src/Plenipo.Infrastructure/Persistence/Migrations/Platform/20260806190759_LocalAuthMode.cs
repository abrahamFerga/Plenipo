...
{
    /// <inheritdoc />
    public partial class LocalAuthMode : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_auth_keys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotpEnabledAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_local_credentials_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_local_auth_keys_Use",
                schema: "platform",
                table: "local_auth_keys",
                column: "Use",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_local_credentials_Email",
                schema: "platform",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_local_credentials_TenantId",
                schema: "platform",
                table: "local_credentials",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_local_credentials_UserId",
                schema: "platform",
                table: "local_credentials",
                column: "UserId",
                unique: true);
