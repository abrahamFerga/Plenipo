...
/// what makes re-running `cortex init` non-destructive by default (the OpenClaw property).
/// </summary>
...
/// <summary>
/// Merges a <see cref="SettingsPlan"/> into an existing cortex.settings.json (or an empty one):
...
/// </summary>
public static class CortexSettingsFile
{
    public const string FileName = "cortex.settings.json";
