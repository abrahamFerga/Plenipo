...
/// </summary>
public sealed class PlenipoSettingsFileTests
{
    [Fact]
    public void Writes_decided_settings_into_the_right_sections()
    {
        var json = PlenipoSettingsFile.Merge(null, new SettingsPlan
        {
            AiProvider = "OpenAI",
            AiModel = "gpt-4o-mini",
            RagEnabled = true,
    ...
    {
        var json = PlenipoSettingsFile.Merge(null, new SettingsPlan { AiProvider = "Mock" });
    ...
    {
        var first = PlenipoSettingsFile.Merge(null, new SettingsPlan { AiProvider = "OpenAI", AiModel = "gpt-4o-mini", RagEnabled = true });
        ...
        edited = PlenipoSettingsFile.Merge(edited, new SettingsPlan { WhatsAppEnabled = true });
    ...
    public void Merging_into_a_partial_section_keeps_its_other_keys()
    {
        ...
        var json = PlenipoSettingsFile.Merge(existing, new SettingsPlan { AiModel = "llama3.1" });
