...
/// </summary>
public sealed class AiDecisionDisclosureTests : IClassFixture<CortexApiFactory>
{
    private readonly CortexApiFactory _factory;

    public AiDecisionDisclosureTests(CortexApiFactory factory) => _factory = factory;
